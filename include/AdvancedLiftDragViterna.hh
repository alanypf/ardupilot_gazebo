...
#ifndef GZ_SIM_SYSTEMS_ADVANCED_LIFT_DRAG_VITERNA_HH_
#define GZ_SIM_SYSTEMS_ADVANCED_LIFT_DRAG_VITERNA_HH_
...
{
  // Forward declaration
  class AdvancedLiftDragViternaPrivate;
  ...
  /// - `<CLaStall>`: Slope of the CL-alpha curve after stall
  /// - `<CDaStall>`: Slope of the CD-alpha curve after stall
  ...
  class AdvancedLiftDragViterna
      : public System,
        public ISystemConfigure,
        public ISystemPreUpdate
  {
    /// \brief Constructor
    public: AdvancedLiftDragViterna();

    /// \brief Destructor
    public: ~AdvancedLiftDragViterna() override = default;
    ...
    private: std::unique_ptr<AdvancedLiftDragViternaPrivate> dataPtr;
  };
  }
}
}
