...
#ifndef GZ_SIM_SYSTEMS_LIFT_DRAG_ROTOR_HH_
#define GZ_SIM_SYSTEMS_LIFT_DRAG_ROTOR_HH_
...
{
  // Forward declaration
  class LiftDragRotorPrivate;

  /// \brief The LiftDragRotor system computes lift and drag forces enabling
  ...
  {
    /// \brief Constructor
    public: LiftDragRotor();

    /// \brief Destructor
    public: ~LiftDragRotor() override = default;
    ...
    private: std::unique_ptr<LiftDragRotorPrivate> dataPtr;
  };
  }
}
}
